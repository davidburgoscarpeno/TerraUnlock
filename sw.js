...
const VERSION = 'mugc1mh5';
const SHELL = 'tu-shell-' + VERSION;
const TILES = 'tu-tiles-v1';
const PRECACHE = ["./assets/browser-DGemqFXA.js","./assets/fit-parser-GrBu7W1E.js","./assets/index-D7EnREfT.js","./assets/index-lWdpeT73.css","./data/peaks-world.json","./icons/apple-touch-icon.png","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-maskable-512.png","./index.html","./manifest.webmanifest"];
