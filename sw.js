...
const VERSION = 'muet8kgh';
const SHELL = 'tu-shell-' + VERSION;
const TILES = 'tu-tiles-v1';
const PRECACHE = ["./assets/browser-DGemqFXA.js","./assets/fit-parser-GrBu7W1E.js","./assets/index-CBJk5vOO.css","./assets/index-Dvrcbl_f.js","./data/peaks-world.json","./icons/apple-touch-icon.png","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-maskable-512.png","./index.html","./manifest.webmanifest"];
